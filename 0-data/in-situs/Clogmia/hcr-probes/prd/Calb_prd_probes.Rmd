...
exclude <- c(1:10, # Too close to 5' end
             11:200, # UTR
             693:744, # BLAST hit to DN11578 and DN13542
             #916:967, # BLAST hit
...
```{r blast-sequences}
# Put the path to your transcriptome file in fasta format
# You should have already generated a BLAST database for it using the command:
# makeblastdb -in transcriptome.fa -dbtype nucl -parse_seqids
probes_blast_db <- "../../../1-data/transcriptome-assembly-denovo/clogmia_transcriptome_denovo.fa"
