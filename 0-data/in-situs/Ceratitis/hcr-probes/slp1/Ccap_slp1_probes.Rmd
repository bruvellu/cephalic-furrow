...
name_fasta_file <- "Ccap_slp1.fa"
# File name with transcriptome in fasta format
probes_blast_db <- "../../../0-Resources/transcriptome/ceratitis_transcriptome.fa"
...
exclude <- c(1:10, # Too close to 5' end
             #11:200, # 5'UTR
             720:746, # BLAST hit
             (gene_length-10):gene_length # Too close to 3'UTR
             )
...
system(paste0("blastn -task blastn-short -query ", name_probes_blast,
              " -db ", probes_blast_db,
              " -out ", name_probes_blast, ".blastn"
              ))
```
