...
ggplot(results, aes(Genotype, Length, color = Genotype)) + geom_violin(draw_quantiles = c("0.5"), show.legend = FALSE) + geom_jitter(width = 0.1, show.legend = FALSE) + facet_wrap(~Sample) + labs(x = "Mutant", y = "Depth") + scale_color_manual(values=c("#d55e00", "#e69f03")) + theme_classic()
