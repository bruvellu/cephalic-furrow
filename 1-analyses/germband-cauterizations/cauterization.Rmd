...
ggplot(summary_embryos, aes(factor(Sample, level = c("control", "cauterized")), Mean, fill = Sample)) +
  ...
  theme(text =  element_text(size = 35),
        panel.background = element_rect(colour = "black", size=1))
ggsave("wt-mean-length.png", width = 7, height = 4)
ggsave("wt-mean-length.svg", width = 7, height = 4)

```

```{r stats}
# Statistical testing
mean_ctrl <- mean(summary_embryos[summary_embryos$Sample == "control",]$Mean)
mean_caut <- mean(summary_embryos[summary_embryos$Sample == "cauterized",]$Mean)
diff_micron <- mean(summary_embryos[summary_embryos$Sample == "control",]$Mean) - mean(summary_embryos[summary_embryos$Sample == "cauterized",]$Mean)
diff_pct <- (mean(summary_embryos[summary_embryos$Sample == "control",]$Mean) - mean(summary_embryos[summary_embryos$Sample == "cauterized",]$Mean)) / mean(summary_embryos[summary_embryos$Sample == "cauterized",]$Mean) * 100

# Test if distribution is normal
shapiro.test(summary_embryos[summary_embryos$Sample == "control",]$Mean)
shapiro.test(summary_embryos[summary_embryos$Sample == "cauterized",]$Mean)
...
wilcox.test(summary_embryos[summary_embryos$Sample == "control",]$Mean,
            summary_embryos[summary_embryos$Sample == "cauterized",]$Mean,
            alternative = "g")
...
ks.test(summary_embryos[summary_embryos$Sample == "control",]$Mean,
            summary_embryos[summary_embryos$Sample == "cauterized",]$Mean,
            alternative = "g")

ks.test(results[results$Sample == "control",]$Length,
            results[results$Sample == "cauterized",]$Length,
            alternative = "g")

t.test(summary_embryos[summary_embryos$Sample == "control",]$Mean,
       summary_embryos[summary_embryos$Sample == "cauterized",]$Mean,
       var.equal = FALSE)
...
var.test(summary_embryos[summary_embryos$Sample == "control",]$Mean,
         summary_embryos[summary_embryos$Sample == "cauterized",]$Mean)
