...
ggplot(datasets, aes(minute, tortuosity, color = sample)) +
  ...
  scale_color_manual(values=c("#e69f03", "#0072b2")) +
  scale_fill_manual(values=c("#e69f03", "#0072b2")) +
...
ggplot(datasets, aes(minute, tortuosity, color = sample, group = interaction(minute, sample))) + geom_boxplot(show.legend = FALSE) + geom_point(position = position_dodge(width = 2), show.legend = FALSE) + facet_wrap(~stock) + labs(x = "minutes", y = "tortuosity") + scale_color_manual(values=c("#e69f03", "#0072b2")) + theme_classic()
...
ggplot(datasets, aes(minute, tortuosity, color = sample, group = interaction(minute, sample))) + geom_boxplot(show.legend = FALSE) + geom_point(alpha = 0.8, position = position_dodge(width = 2), show.legend = FALSE) + labs(x = "minutes", y = "tortuosity") + scale_color_manual(values=c("#e69f03", "#0072b2")) + theme_classic()
ggsave("tortuosity_all_boxplot.png")
```

```{r all-smooth}
# Plot stocks together using lines
ggplot(datasets, aes(minute, tortuosity, color = sample)) + geom_smooth(span = 0.3, show.legend = FALSE) + labs(x = "minutes", y = "tortuosity") + scale_color_manual(values=c("#e69f03", "#0072b2")) + theme_classic()
