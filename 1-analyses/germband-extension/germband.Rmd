...
```{r plot-gb-pct}
ggplot(gblong, aes(stock, gb_pct, color = zygosity, fill = zygosity)) +
...
```{r plot-gb-time}
ggplot(gblong, aes(stock, gb_time, color = zygosity, fill = zygosity)) +
  geom_violin(draw_quantiles = c("0.5"), show.legend = TRUE, trim = TRUE, alpha = 0.3, scale = "area", adjust = 1) +
  geom_point(alpha = 0.8, size = 2, show.legend = TRUE, position = position_jitterdodge(dodge.width = 1, jitter.width = 0.10)) +
  scale_fill_manual(values=c("#56b4e9", "#e69f03", "#cc79a7")) +
  scale_color_manual(values=c("#56b4e9", "#e69f03", "#cc79a7")) +
...
```{r plot-gb-pct-buck}
ggplot(gblong[gblong$status == "buck",], aes(stock, gb_pct, color = zygosity, fill = zygosity)) +
  geom_violin(draw_quantiles = c("0.5"), show.legend = FALSE, trim = TRUE, alpha = 0.3, scale = "area", adjust = 1) +
...
ggsave("2-plots/gb_pct_buck.png", width = 15, height = 8)
ggsave("2-plots/gb_pct_buck.svg", width = 15, height = 8)
```

Then the time after gastrulation:

```{r plot-gb-time-buck}
ggplot(gblong[gblong$status == "buck",], aes(stock, gb_time, color = zygosity, fill = zygosity)) +
  geom_violin(draw_quantiles = c("0.5"), show.legend = FALSE, trim = TRUE, alpha = 0.3, scale = "area", adjust = 1) +
  geom_point(alpha = 0.8, size = 2, show.legend = FALSE, position = position_jitterdodge(dodge.width = 1, jitter.width = 0.10)) +
  scale_fill_manual(values=c("#56b4e9", "#e69f03", "#cc79a7")) +
  scale_color_manual(values=c("#56b4e9", "#e69f03", "#cc79a7")) +
...
ggsave("2-plots/gb_time_buck.png", width = 15, height = 8)
ggsave("2-plots/gb_time_buck.svg", width = 15, height = 8)
```
...
```{r plot-gb-pct-deep}
ggplot(gblong[gblong$status == "deep",], aes(stock, gb_pct, color = zygosity, fill = zygosity)) +
  geom_violin(draw_quantiles = c("0.5"), show.legend = FALSE, trim = TRUE, alpha = 0.3, scale = "area", adjust = 1) +
  geom_point(alpha = 0.8, size = 2, show.legend = FALSE, position = position_jitterdodge(dodge.width = 1, jitter.width = 0.10)) +
  scale_fill_manual(values=c("#56b4e9", "#e69f03", "#cc79a7")) +
  scale_color_manual(values=c("#56b4e9", "#e69f03", "#cc79a7")) +
...
ggsave("2-plots/gb_pct_deep.png", width = 15, height = 8)
ggsave("2-plots/gb_pct_deep.svg", width = 15, height = 8)
```

```{r plot-gb-time-deep}
ggplot(gblong[gblong$status == "deep",], aes(stock, gb_time, color = zygosity, fill = zygosity)) +
  geom_violin(draw_quantiles = c("0.5"), show.legend = FALSE, trim = TRUE, alpha = 0.3, scale = "area", adjust = 1) +
  geom_point(alpha = 0.8, size = 2, show.legend = FALSE, position = position_jitterdodge(dodge.width = 1, jitter.width = 0.10)) +
  scale_fill_manual(values=c("#56b4e9", "#e69f03", "#cc79a7")) +
  scale_color_manual(values=c("#56b4e9", "#e69f03", "#cc79a7")) +
...
ggsave("2-plots/gb_time_deep.png", width = 15, height = 8)
ggsave("2-plots/gb_time_deep.svg", width = 15, height = 8)
```