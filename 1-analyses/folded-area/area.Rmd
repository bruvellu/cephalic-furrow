...
```{r individual-area-per-fold-type}
...
ggsave("4-plots/individual-area-per-fold-type.png", width = 5, height = 7)
ggsave("4-plots/individual-area-per-fold-type.svg", width = 5, height = 7)
