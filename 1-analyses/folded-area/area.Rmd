...
## Overview plots for all genes
```{r area-overview}
# Corrected area of individual folds per position
ggplot(results, aes(Stock, AreaCorr, colour = Genotype)) +
  geom_jitter(alpha = 0.8, width = 0.1, size = 2) +
  labs(x = "stock", y = expression(paste("folded area ", (µm^2)))) +
  facet_wrap(~Position, strip.position = "top") +
  theme_minimal() +
