...
ggplot(total, aes(factor(Stock, level = c("wt", "btd", "eve", "prd")), AreaCorr, fill = Genotype)) +
...
ggsave("4-plots/total-area-per-embryo.png", width = 15, height = 10)
ggsave("4-plots/total-area-per-embryo.svg", width = 15, height = 10)
...
ggsave("4-plots/area-individual-folds.png", width = 15, height = 6)
ggsave("4-plots/area-individual-folds.svg", width = 15, height = 6)
```
