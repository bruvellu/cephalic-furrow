...
## Plot developmental percentage of events
...
ggplot(percent[percent$embryo %in% c("2024-07-29_17", "2024-07-29_10"), ], aes(x=reorder(embryo, value), y=value, fill = event)) +
...
ggsave("2-plots/dataclean-percent_event-vs-condition.svg", width = 25, height = 8)
```
