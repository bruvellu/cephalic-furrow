...
```{r outliers}
# Exclude outliers
#means <- means[means$Velocity < 0.4,]
means[means$Distance == 15,]$Distance <- 20
means[means$Distance == 25,]$Distance <- 30
#means[means$Distance == 35,]$Distance <- 40
means[means$Distance == -15,]$Distance <- -20
means[means$Distance == -25,]$Distance <- -30
#means[means$Distance == -35,]$Distance <- -40
```
...
ggplot(means, aes(Stage, Velocity, )) +
