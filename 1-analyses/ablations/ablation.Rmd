...
by(ablations[ablations$Position == "A", c("Velocity")], ablations[ablations$Position == "A",]$Stage, summary)
print("")
by(ablations[ablations$Position == "P", c("Velocity")], ablations[ablations$Position == "P",]$Stage, summary)
```
...
ggsave("2-plots/recoil-velocity.png", width = 14, height = 7)
ggsave("2-plots/recoil-velocity.svg", width = 14, height = 7)
```

```{r stage}
set.seed(1234)
# Plot mean length of cephalic furrow per embryo (right/left sides)
ggplot(ablations[ablations$Velocity > 0,], aes(Stage, Velocity)) +
