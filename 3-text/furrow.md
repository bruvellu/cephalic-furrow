...
@fig:mitotic). The most common position is near the canonical cephalic
...
{@fig:mitotic}D). The apical area of epithelial cells about to fold
...
{@fig:mitotic}E). The epithelium simply buckles when compressed by
