...
We performed a live-imaging screen (Supplementary Note 4) and found that the *sloppy paired* (*slp*) transcription factors plays a role in the positioning of initiator cells ({@fig:genetic-patterning}a--d, {!@fig:genetic-features}b--d, {!@fig:vid-slp-lateral}, Supplementary Note 5).
