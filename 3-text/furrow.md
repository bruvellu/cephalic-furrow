...
The role of mitotic domains and germ band as stressors is corroborated by complementary experiments performed in the co-submitted study by Dey et al. [@Dey2023-pj], consolidating the evidence that the head--trunk interface of flies is under increased mechanical stress during gastrulation.
...
If this is the case, we expect that this increased mechanical instability to be detrimental to the fitness of individuals.
Dey et al. show that inhibiting cephalic furrow formation increases the frequency of a distorted ventral midline in *Drosophila*, suggesting that the variable ectopic buckling can cause mechanical imbalance between tissues during gastrulation [@Dey2023-pj].
This instability can impact the robustness of morphogenetic processes and potentially slow down embryogenesis.
While further work is needed to investigate the direct effects of mechanical compression and buckling to the cell-to-cell interactions and short-range signaling at the head--trunk boundary, the fact that ectopic buckling impacts developmental robustness and speed could be a significant factor under more strict selection regimes.
...
If this was the case, we expect that the sources of stress (mitotic domains and germ band extension) to be present in the fly lineage before the origin of the cephalic furrow.
By mapping the presence of the cephalic furrow across the dipteran phylogeny, Dey et al. show that the cephalic furrow is an evolutionary novelty of cyclorraphan flies [@Dey2023-pj].
...
Remarkably, fly species without a cephalic furrow seem to have evolved an alternative solution to deal with this mechanical instability.
*Clogmia* and *Chironomus* exhibit out-of-plane cell divisions exactly at the head--trunk boundary and they play a role in reducing the compressive load during gastrulation [@Dey2023-pj] ({@fig:summary}a).
...
Therefore, the appearance of a head--trunk domain of *btd*, and the establishment of a *btd*--*eve* overlap were crucial events that preceded the evolution of the cephalic furrow.

<!--Altogether, the combined genetics and mechanics data from our study and the co-submitted study by Dey et al.-->

<!--raises the following evolutionary scenario for the cephalic furrow ({@fig:summary}b).-->
