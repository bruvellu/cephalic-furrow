...
<!--TODO: Abstract before streamlining-->
<!--Mechanical forces are crucial for driving and shaping tissue morphogenesis during embryonic development [@Keller2012-ca; @Heisenberg2013-pl; @Collinet2021-qa]. However, their relevance for the evolution of development remains poorly understood [@Loffet2023-nj]. Here, we show that a morphogenetic innovation present in fly embryos---a deep epithelial fold known as the cephalic furrow [@Hartenstein1985-zs; @Foe1989-cw; @Spencer2015-td]---plays a mechanical role during *Drosophila* gastrulation. By integrating *in vivo* experiments and *in silico* simulations, we find that the formation of the cephalic furrow prevents mechanical instabilities at the head--trunk epithelium by absorbing the compressive stresses generated by concurrent morphogenetic movements of gastrulation, the expansion of mitotic domains and the germ band extension. Furthermore, by comparing the expression of known and novel genes involved in cephalic furrow formation between fly species, we find that the presence of the cephalic furrow is linked to changes in the expression of *buttonhead* transcription factor at the head--trunk boundary. These data suggest that the genetic control of cephalic furrow formation was established through the integration of a new player into the ancestral head--trunk patterning system, and that mechanical instability may have been the selective pressure associated with the evolution of the cephalic furrow. Our findings uncover empirical evidence for how mechanical forces can influence the evolution of morphogenetic innovations in early development.-->

<!--TODO: Abstract EED-->
<!--Morphogenesis is a physical process. When embryonic tissues move, extend, or fold, they push and pull neighboring tissues. These mechanical interactions are crucial to shape tissues and organs during development, but their importance for embryo evolution is less understood. Here, we investigate an enigmatic epithelial fold that demarcates the head–trunk boundary of fly embryos during gastrulation—the cephalic furrow. Despite forming under strict genetic control, the cephalic furrow is transient and doesn't give rise to any precursor tissues. We show that perturbing its formation compromises the stability of the head–trunk epithelium. Without the cephalic furrow, the concomitant formation of mitotic domains in the head, and extension of the germ band in the trunk, increase the mechanical stress at the head–trunk interface. This leads to uncontrolled epithelial buckling. In normal development, the cephalic furrow absorbs these mechanical stresses by priming the position of folding, and removing cells from the surface before other morphogenetic movements. Our work suggests the cephalic furrow plays a mechanical role in preventing epithelial instabilities at the head–trunk boundary during Drosophila gastrulation. We discuss how the mechanical stresses of dipteran gastrulation may have acted as a selective pressure for the evolution of the cephalic furrow.-->

<!--Mechanical forces play a crucial role in driving and shaping the development of tissues and organs during embryonic development. However, their relevance for the evolution of morphogenetic processes remains poorly understood. In this study, we investigate the mechanical role of a morphogenetic innovation known as the cephalic furrow, which is present in fly embryos during gastrulation. Through a combination of in vivo experiments and in silico simulations, we demonstrate that the formation of the cephalic furrow effectively prevents mechanical instabilities at the head-trunk epithelium by absorbing the compressive stresses generated by gastrulation movements. Additionally, by comparing the expression of known and novel genes involved in cephalic furrow formation between fly species, we find a link between the presence of the cephalic furrow and the appearance of a novel buttonhead expression domain at the head-trunk boundary. These findings suggest that the genetic control of cephalic furrow formation evolved through the integration of a new player into the ancestral head-trunk patterning system, and that mechanical instability may have been the selective pressure associated with the evolution of the cephalic furrow. Overall, our study provides evidence for the influence of mechanical forces on the evolution of morphogenetic innovations in early development.-->


# Main

<!--TODO: Reduce intro from 503 to 500 words-->
...
<!--TODO: Revise passages and use them somewhere?-->
...
<!--TODO: Revise passages below and re-use if needed-->
...
Our work investigates the developmental role and evolution of the cephalic furrow. We find that tissues at the head--trunk boundary of *Drosophila* are under increased compressive stress due to the concomitant formation of mitotic domains and germ band extension. Without the cephalic furrow, these stresses build up, and the outward forces exerted by cell divisions in a compressed epithelial monolayer cause mechanical instability and tissue buckling [@Kondo2013-gy; @Freddo2016-et] (Supplementary Note 7). Our results provide evidence the formation of the cephalic furrow counteracts these compressive stresses and prevents epithelial instabilities at the head--trunk boundary. Therefore, we propose that the cephalic furrow plays a mechanical role during *Drosophila* gastrulation.
...
The distribution of cephalic furrow traits onto the dipteran phylogeny is consistent with the hypothesis of mechanical instability as a selective pressure ({@fig:summary}a). Mitotic domains and germ band extension---the sources of stress---are ancestral and evolved before the cephalic furrow, a derived trait and evolutionary novelty of cyclorraphan flies [@Dey2023-mo] ({@fig:summary}a). Remarkably, species without cephalic furrow show out-of-plane cell divisions at the head--trunk boundary [@Dey2023-mo], an alternative strategy for mitigating compressive stresses ({@fig:summary}b). Since the establishment of a *btd--eve* overlap is associated with the presence of the cephalic furrow [@Dey2023-mo] ({@fig:genetic-patterning}, {@fig:summary}a), differences in the genetic patterning of the dipteran head--trunk boundary might have contributed to the origin of distinct morphogenetic solutions in response to a similar mechanical selective pressure ({@fig:summary}b).
...
<!--This physical role is intriguing for a genetically patterned invagination, and raises the idea that the cephalic furrow may have evolved in response to the mechanical challenges of dipteran gastrulation.-->

<!--Having only a physical role is intriguing, considering it is a genetically patterned invagination-->

<!--A patterned invagination having only a physical role is intriguing, and raises the idea that the cephalic furrow may have evolved in response to the mechanical challenges of dipteran gastrulation.-->

<!--In this case, we expect mechanical instability to affect embryogenesis and decrease the fitness of individuals.-->
<!--A patterned invagination having only a physical role is intriguing, and raises the idea that the cephalic furrow may have evolved in response to the mechanical challenges of dipteran gastrulation, with mechanical instability as selective pressure. -->

<!--Remarkably, species without the cephalic furrow exhibit out-of-plane cell divisions at the head--trunk boundary [@Dey2023-mo], an alternative strategy that mitigates compressive stresses during gastrulation ({@fig:summary}a,b).-->

<!--TODO: Incorporate good parts of partially edited discussion-->

<!--Our cephalic furrow studies uncover a potentially more general mechanism for how tissue mechanics can influence developmental evolution.-->

<!--Classical theoretical work by Newman and Müller proposed that self-organized morphogenesis was critical to generate morphogenetic innovations at the dawn of animal evolution [@Newman2000-oz].-->

<!--Our works provide initial empirical evidence supporting this hypothesis, and suggest that mechanical forces might have had a critical role in generating morphogenetic innovations not only at the transition to multicellularity, but also after the establishment of developmental patterning systems.-->

<!--We propose the genetic stabilization of mechanical conflicts between embryonic processes may be a broadly occurring mechanism contributing to generating the remarkable morphogenetic diversity of early animal embryogenesis.-->

<!--TODO: Partially streamlined discussion after PT-->
...
<!--This physical role raises a stirring hypothesis---that the cephalic furrow may have evolved in response to the mechanical challenges of dipteran gastrulation. To be the case, the sources of stress must have appeared before the cephalic furrow during dipteran evolution, and we also expect mechanical instability to be detrimental to individual fitness to act as a selective pressure. The trait distribution on the dipteran phylogeny does indicate that mitotic domains and germ band extension are ancestral and common to all Diptera, while the cephalic furrow is a derived trait---an evolutionary novelty of cyclorraphan flies [@Dey2023-mo] ({@fig:summary}a). Remarkably, species without a cephalic furrow exhibit out-of-plane cell divisions at the head--trunk boundary which also mitigate the effect of tissue compression during gastrulation [@Dey2023-mo] ({@fig:summary}a), suggesting these flies may have evolved an alternative solution to a similar mechanical challenge ({@fig:summary}b). Differences in genetic patterning might explain these distinct morphogenetic solutions. Since only species with the cephalic furrow show a *btd--eve* head--trunk overlap [@Dey2023-mo] ({@fig:genetic-patterning}, {@fig:summary}a), a trait essential for the specification of initiator cells in *Drosophila*, the establishment of this domain, likely within the Cyclorrapha lineage, was probably a key event associated with the origin of the cephalic furrow. Even though there are potential detrimental effects of ectopic folding (Supplementary Note 8), it remains to be demonstrated experimentally that mechanical instability can act as a selective pressure for the evolution of morphogenesis. While our efforts to test this challenging hypothesis have failed so far, there is evidence that inhibiting the cephalic furrow via optogenetics increases the frequency of embryos showing a distorted ventral midline [@Dey2023-mo], suggesting that mechanical instability can impact the robustness of morphogenetic processes.-->

<!--Our cephalic furrow studies uncover a potentially more general mechanism for how tissue mechanics can influence developmental evolution. Classical theoretical work by Newman and Müller proposed that self-organized morphogenesis was critical to generate morphogenetic innovations at the dawn of animal evolution [@Newman2000-oz]. Our works provide initial empirical evidence supporting this hypothesis, and suggest that mechanical forces might have had a critical role in generating morphogenetic innovations not only at the transition to multicellularity, but also after the establishment of developmental patterning systems. We propose the genetic stabilization of mechanical conflicts between embryonic processes may be a broadly occurring mechanism contributing to generating the remarkable morphogenetic diversity of early animal embryogenesis.-->
...
![Interplay of genetics and mechanics during cephalic furrow evolution.
**a**, Cephalic furrow traits mapped onto a simplified dipteran phylogeny (based on  Ref[@Wiegmann2011-ou]). Germ band extension and mitotic domains are ancestral, suggesting compressive stresses at the head--trunk boundary were present since the dawn of Diptera. The cephalic furrow is present in the common ancestor of *Megaselia* and *Drosophila* (cyclorraphan flies), and correlates with the presence of a *btd--eve* overlap at the head--trunk boundary. Out-of-plane divisions are present at the head--trunk boundary of the non-cyclorraphan flies *Clogmia* and *Chironomus*. Data sources are annotated with geometrical symbols: this study (black circle), Dey, Kaul, Kale *et al.* [@Dey2023-mo] (black triangle), and Eritano et al. [@Eritano2020-mi] and Vincent et al. [@Vincent1997-fa] (black square).
...
**j**, Proportion of ectopic folding positions (anterior, middle, posterior) in wildtype (n=28), *btd* heterozygotes (n=6) and homozygotes (n=12), *eve* heterozygotes (n=7) and homozygotes (n=10), *prd* heterozygotes (n=7) and homozygotes (n=10), *stg* heterozygotes (n=12) and homozygotes (n=3).
...
<!--TODO: Previous legends for stg mutants-->
...
<!--### Potential detrimental effects of mechanical stress-->
