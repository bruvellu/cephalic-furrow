...
cauterized mutants shows less deformations ({@fig:cauterization}D--F) and lower
tissue strain ({@fig:strain}B) when compared to non-cauterized mutants. These
experiments reveal that the local forces generated by the mitotic domains alone
are insufficient to cause the tissue to buckle, and that instead, the major
...
<!--FIXME: Cauterized eve embryos n = 1... ![Strain analysis of cauterized eve embryos.](figures/FigS3.jpg){#fig:strain tag=S3 width=100%}-->
