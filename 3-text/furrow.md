...
The invagination forms under strict genetic control [@Vincent1997-fa] using active cell shape changes [@Eritano2020-mi].
But the cephalic furrow is transient and unfolds without a trace, and its function in has remained elusive.
Here we show the cephalic furrow plays a mechanical role in *Drosophila* gastrulation.
By live-imaging mutant embryos, we find the absence of the cephalic furrow impacts the epithelial stability at the head--trunk interface, leading to the formation of ectopic folds.
Using in vivo perturbations and in silico simulations, we show that ectopic folding occurs by tissue buckling due to extrinsic compressive stresses generated by the concomitant formation of mitotic domains and extension of the germ band.
Our findings suggest that in normal development the cephalic furrow absorbs the mechanical stresses at the head--trunk boundary by priming the position of folding, and by removing cells from the surface before other morphogenetic movements take place.
We propose the cephalic furrow prevents epithelial instabilities during *Drosophila* gastrulation.
