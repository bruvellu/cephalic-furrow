...
Our work investigates the function and evolution of the cephalic furrow---a pre-patterned epithelial invagination forming at the head--trunk boundary of dipteran flies.
We provide evidence that the cephalic furrow accomplishes a physical role during *Drosophila* gastrulation and reveal gene expression changes potentially associated with its evolution.

<!--CF prevents mechanical instability generated by gastrulation movements-->
...
<!--MD and GB as sources of mechanical stress-->
...
<!--Head--trunk under mechanical stress-->

Our data suggest a similar situation is occurring at the head--trunk boundary of cephalic furrow mutants.
The synchronized apical expansion of dividing cells in mitotic domains pushes the adjacent non-dividing cells outward, and forms potentially unstable regions of different epithelial thickness, while the germ band extension generates a global compression on the head--trunk interface ({@fig:experiments}j).
