...
**c**, Lateral view of heterozygote (sibling controls) homozygote embryos (mutants) of *btd* and *eve* during gastrulation. Percentages indicate the extent of germ band extension relative to egg length. Scale bars = 50\ µm.
...
Asterisks indicate p < 0.05 in a two-sided Mann--Whitney *U* test contrasting the condition against wildtype.
The presence of ectopic folds was highly repeatable across 7 independent experiments in *btd* mutants (46 embryos) and 5 independent experiments in *eve* mutants (36 embryos).
The membrane marker in panels **b**, **c**, **f**, and **g** is Gap43-mCherry.
Embryonic staging based on standard developmental tables [@Campos-Ortega1985-ma; @Ashburner2005-ym].
...
**c**, *btd*--*stg* double mutants. The phenotype was consistent in 5 double homozygote embryos from 6 independent experiments (35 embryos). Scale bar = 50\ µm.
...
<!--TODO: Reduce from 538 to 300 words-->
...
**f**, Maximum folding depth in *btd* and *eve* mutants. Ectopic folds are shallower than the cephalic furrow (p < 0.001). Asterisks indicate p < 0.05 in a two-sided Mann--Whitney *U* test. Data points correspond to individual folds. Samples: *btd* heterozygotes (32 embryos, 52 CFs, 6 EFs) and homozygotes (7 embryos, 28 EFs), *eve* heterozygotes (20 embryos, 34 CFs, 4 EFs) and homozygotes (4 embryos, 15 EFs). 
**g**, Area of ectopic folds in wildtype and mutant embryos (pooled *btd*, *eve*, and *prd*). Ectopic folds are smaller in wildtype compared to mutants (p < 0.001). Asterisks indicate p < 0.05 in a two-sided Mann--Whitney *U* test. Samples: wildtype (16 embryos, 14 EFs), heterozygotes (9 embryos, 7 EFs), and homozygotes (14 embryos, 28 EFs).
...
<!--TODO: Reduce from 454 to 300 words-->
...
**f**, Strain rate analysis at the head--trunk (top) and trunk--germ (bottom) regions of *btd* heterozygotes (n = 3) and homozygotes (n = 3). Filled triangles indicate the beginning of cephalic furrow (CF), mitotic domains (MD), and ectopic folds (EF) formation. MD~i~ marks the initial metaphase expansion and MD~ii~ the moment of cell division during telophase. Empty triangles indicate peaks of strain rate. Letters A--D show the exact frames from {!@fig:apical-strain}b. Measurements combine isotropic and anisotropic strain rate. The plotted line and shaded area represent the mean predicted values from the regression and the 95% confidence interval, respectively.
**g**, Dynamics of trunk--germ tissues after laser cuts in wildtype embryos. We measured the distance between pairs of cell vertices over time in control (n = 3) and ablated embryos (n = 3). Tracks are color-coded for time (rainbow colors). Solid white line represents the distance between vertices at one timepoint. Dashed white line shows the cut location. We only analyzed embryos where the vitelline envelope remained intact after the laser pulse. Plots show a smoothed local regression with a 95% confidence interval shaded band. Scale bar = 20\ µm.
